...
public class NotificationsController {
    ...
    public NotificationsController(NotificationService notificationService) { this.notificationService = notificationService; }
    ...
    @PostMapping("/api/email/send-verification") public Map<String, Object> sendVerification(@RequestBody Map<String, Object> payload) { return notificationService.sendVerification(payload); }
    @PostMapping("/api/email/verify-code") public Map<String, Object> verifyCode(@RequestBody Map<String, Object> payload) { return notificationService.verifyCode(payload); }
