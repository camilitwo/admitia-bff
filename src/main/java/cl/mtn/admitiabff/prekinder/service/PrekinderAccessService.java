...
public class PrekinderAccessService {
    ...
    private static final Set<String> MODULE_ROLES = Set.of(
        "ADMIN", "COORDINATOR", "CYCLE_DIRECTOR", "TEACHER", "PSYCHOLOGIST", "INTERVIEWER", "EVALUATOR", "PREKINDER_PROFESSIONAL", "APODERADO",
        ...
        "PK_EVALUATOR_FAMILY_INTERVIEW", "PK_EVALUATOR_LEARNING_SUPPORT", "PK_EVALUATOR_DAP", "PREKINDER_ACADEMIC", "PREKINDER_PSYCHOMOTOR",
    ...
    private static final Set<String> EVALUATOR_ROLES = Set.of(
        "ADMIN", "COORDINATOR", "CYCLE_DIRECTOR", "TEACHER", "PSYCHOLOGIST", "INTERVIEWER", "EVALUATOR",
        "PREKINDER_PROFESSIONAL", "PK_ADMIN",
        ...
        "PK_EVALUATOR_FAMILY_INTERVIEW", "PK_EVALUATOR_DAP", "PREKINDER_ACADEMIC", "PREKINDER_PSYCHOMOTOR", "PREKINDER_PSYCHOLOGY",
    ...
    public PrekinderActor requireOperations() {
        PrekinderActor actor = requireActor();
        if (!Set.of("ADMIN", "COORDINATOR", "CYCLE_DIRECTOR", "PK_ADMIN", "PK_COORDINATOR", "PK_RECEPTION", "PK_DATA_ENTRY")
                .contains(actor.role())) {
